        ...
        <div className="mb-12 grid grid-cols-1 items-start gap-x-12 gap-y-5 md:mb-18 md:grid-cols-2 md:gap-y-8 lg:mb-20 lg:gap-x-20 lg:gap-y-16">
          <div className="animate-slide-up">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-bizzie-900 dark:text-bizzie-100 mb-6 leading-tight">
              Transform Your Business with <span className="text-bizzie-600 dark:text-bizzie-400">Bizzie</span> Today
            </h1>
          </div>
          <div className="animate-slide-up" style={{animationDelay: '0.2s'}}>
            <p className="text-lg text-bizzie-700 dark:text-bizzie-300 mb-8 leading-relaxed">

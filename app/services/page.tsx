          ...
          <div className="container">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-bizzie-900 dark:text-white mb-6 leading-tight">
                Our <span className="text-bizzie-600">Services</span>
              </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {services.map((service, index) => (
                <div key={index} className="bg-white dark:bg-bizzie-800 rounded-xl p-8 shadow-soft-lg border border-bizzie-200 dark:border-bizzie-700 hover:shadow-soft-xl transition-shadow">
                  ...
                  <h3 className="text-2xl font-bold text-bizzie-900 dark:text-white mb-4">
                    {service.title}
                  </h3>
                  <p className="text-bizzie-700 dark:text-bizzie-200 mb-6 leading-relaxed">
                    {service.description}
                  </p>
        ...
        <section className="px-[5%] py-16 md:py-24 lg:py-28 section-bg-light-accent">
          <div className="container">
            <div className="max-w-4xl mx-auto text-center mb-16">
              ...
              <p className="text-lg text-bizzie-700 dark:text-bizzie-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-bizzie-900 dark:text-white mb-4">Connect Your Accounts</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-bizzie-900 dark:text-white mb-4">Organize & Categorize</h3>
                <p className="text-bizzie-700 dark:text-bizzie-200">
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-bizzie-900 dark:text-white mb-4">Optimize & Grow</h3>
                <p className="text-bizzie-700 dark:text-bizzie-200">
